...
train_art = tf.keras.utils.image_dataset_from_directory('data/romanticism', validation_split=0.2, subset='training', seed=123, image_size=(256, 256), labels=None, batch_size=None)
test_art = tf.keras.utils.image_dataset_from_directory('data/romanticism', validation_split=0.2, subset='validation', seed=123, image_size=(256, 256), labels=None, batch_size=None)
...
images_dir = './romanticism/results'
